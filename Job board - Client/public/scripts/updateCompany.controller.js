...
function UpdateCompanyControllerFn($state,$http,$uibModal) {
	...
	vm.fetchCompanyDetails = function(){
		$http.get("http://ec2-54-153-93-47.us-west-1.compute.amazonaws.com/getCompanyDetails", {
	...
	vm.updateCompany = function() {
 		...
 		$http.post("http://ec2-54-153-93-47.us-west-1.compute.amazonaws.com/updateCompanyDetails",reqJSON, {
    		headers: {'Access-Control-Allow-Origin' : '*',
                'Access-Control-Allow-Methods' : 'POST, GET, OPTIONS',
                'Accept': 'application/json'}
  		}).
