...
function LoginControllerCompanyFn($state,$http,$uibModal) {
	...
	vm.home = {};
	vm.home.message = '';
	vm.register.imageURL = 'http://ec2-54-153-93-47.us-west-1.compute.amazonaws.com/myImage.jpg'
	...
	vm.registerCompany = function() {
 		...
 		$http.post("http://ec2-54-153-93-47.us-west-1.compute.amazonaws.com/signUpCompany",reqJSON, {
 	...
 	vm.login = function() {
 		...
 		$http.post("http://ec2-54-153-93-47.us-west-1.compute.amazonaws.com/login",reqJSON, {
    		headers: {'Access-Control-Allow-Origin' : '*',
                'Access-Control-Allow-Methods' : 'POST, GET, OPTIONS',
                'Accept': 'application/json'}
  		}).
